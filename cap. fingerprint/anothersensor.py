...
DATABASE_PATH = "/home/ubuntu22/fingerprint/r307sensor/fingerprints.db"
save_dir = os.path.expanduser("/home/ubuntu22/fingerprint/r307sensor/fingerprints")
...
MODEL_PATH = "/home/ubuntu22/fingerprint/r307sensor/model/Resnet18_scratch_CrossMatch.pt"
...
class AnotherSensor:
    ...
    def spoof_detection_algorithm(self, image_path):
        ...
        try:
            ...
            image = image.rotate(180)  # Rotate image as required by the model
